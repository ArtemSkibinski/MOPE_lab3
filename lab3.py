...
Y1 = (A[0][0] + A[0][1] + A[0][2]) / m
Y2 = (A[1][0] + A[1][1] + A[1][2]) / m
Y3 = (A[2][0] + A[2][1] + A[2][2]) / m
Y4 = (A[3][0] + A[3][1] + A[3][2]) / m
print("Y1 = ", round(Y1, 3))
print("Y2 = ", round(Y2, 3))
print("Y3 = ", round(Y3, 3))
print("Y4 = ", round(Y4, 3))
...
print("y3 = ", round(y3, 3))
print("y4 = ", round(y4, 3))
if(round(y1, 3) == round(Y1, 3) and round(y2, 3) == round(Y2, 3) and round(y3, 3) == round(Y3, 3) and round(y4, 3) == round(Y4, 3)):
    print("Перевіркою переконуємось, що коефіціенти рівняння регресії знайдено правильно")
else: print("Перевіркою переконуємось, що коефіціенти рівняння регресії знайдено неправильно")


print("Перевірка однорідності дисперсії за критерієм Кохрена:")

print("Знайдемо дисперсії по рядках:")
D1 = ((A[0][0]-Y1)**2 + (A[0][1]-Y1)**2 + (A[0][2]-Y1)**2) / m
D2 = ((A[1][0]-Y2)**2 + (A[1][1]-Y2)**2 + (A[1][2]-Y2)**2) / m
D3 = ((A[2][0]-Y3)**2 + (A[2][1]-Y3)**2 + (A[2][2]-Y3)**2) / m
D4 = ((A[3][0]-Y4)**2 + (A[3][1]-Y4)**2 + (A[3][2]-Y4)**2) / m
print("D1 = ", round(D1, 3))
print("D2 = ", round(D2, 3))
print("D3 = ", round(D3, 3))
print("D4 = ", round(D4, 3))
...
q = 0.05
print("Нехай рівень значимості q = ", q)

Gt = 0.7679
print("За таблицею в 4 рядку 2 стовпчику Gt = ", Gt)

if(Gp < Gt):
    print("Gp < Gt, отже дисперсія однорідна. Критерій Кохрена виконується")
else:
    print("Gp > Gt, отже дисперсія неоднорідна. Збільшіть кількість дослідів (m)")
